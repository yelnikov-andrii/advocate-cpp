...
namespace Advocate {
	...
	/// Summary for MyForm1
	/// </summary>
	public ref class EditCase : public System::Windows::Forms::Form
	{
	public:
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (title == "" || description == "" || status == "") {
			...
			CasesManager^ casesManager = gcnew CasesManager();
			Case^ foundCase = casesManager->getOne(this->caseId, "cases.txt");

			bool res = casesManager->editCase(this->caseId, title, description, status, "cases.txt");

			if (res == true) {
				MessageBox::Show("Справу змінено!", "Успіх", MessageBoxButtons::OK, MessageBoxIcon::Information);
